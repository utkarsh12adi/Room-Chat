<div class="col-lg-8">
    <div class="panel panel-default" style="height:50px;">
		...
		<div class="pull-right" style="margin-right:10px; margin-top:7px;">
			<a href="#add_chatroom" data-toggle="modal" class="btn btn-primary" id="addingroom"><span class="glyphicon glyphicon-plus"></span> Add</a>
		</div>
	</div>
	<table width="100%" class="table table-striped table-bordered table-hover" id="chatRoom">
		...
		<?php
			...
			<tr>
				...
				<td><button value="<?php echo $row['chatroomid']; ?>" class="btn btn-info join_chat" id="joinok"><span class="glyphicon glyphicon-comment"></span> Join</button> &nbsp;
					<?php
					if (!empty($row['chat_password'])){
